export const BRIDGE_URLS = [
  'wss://www.figure.tech/service-wallet-connect-bridge/ws/external/silenceActive',
  'wss://test.figure.tech/service-wallet-connect-bridge/ws/external/silenceActive',
