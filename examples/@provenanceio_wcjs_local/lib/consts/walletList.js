...
var WALLET_LIST = [{
  ...
  generateUrl: function () {
    var _generateUrl = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(QRCodeUrl) {
      var url, linkData, linkProd;
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              url = _urls.FIREBASE_FETCH_WALLET_URL;
              linkData = encodeURIComponent(decodeURIComponent(QRCodeUrl));
              linkProd = "".concat(_dynamicLinkInfo.DYNAMIC_LINK_INFO_PROD.link, "?data=").concat(linkData); // First fetch prod, then dev

              return _context.abrupt("return", fetch(url, {
                method: 'POST',
                body: JSON.stringify({
                  dynamicLinkInfo: _objectSpread(_objectSpread({}, _dynamicLinkInfo.DYNAMIC_LINK_INFO_PROD), {}, {
                    link: linkProd
                  })
                })
  ...
  eventAction: function eventAction(_ref2) {
    ...
    var url = "".concat(_urls.FIGURE_WEB_WALLET_URL).concat(searchParamsString ? "?".concat(searchParamsString) : '');
    var width = 600;
...
exports.WALLET_LIST = WALLET_LIST;