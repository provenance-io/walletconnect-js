// --------------------------------------------------------------------------------------------------------------------------------------------------------
// NOTE: This is for the next iteration of signMessage where more work is done in the walletConnect side vs having work done mobile wallet side
// --------------------------------------------------------------------------------------------------------------------------------------------------------
...
// export const signMessageFull = async (state, message) => {
