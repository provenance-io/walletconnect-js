      ...
      <div className="wcjs-qr-appicongroup">
        ...
        >
          <img
            ...
            className="wcjs-qr-appicon-element"
            height="42px"
            width="146px"
          />
        </a>
  ...
  return showModal ? (
    ...
    >
      <div onClick={(e) => e.stopPropagation()} className="wcjs-qr-content">
        <p className="wcjs-modal-title">Connect Wallet</p>
        <div
          onClick={() => wcs.updateModal({ showModal: false })}
        ...
        <p className="wcjs-modal-subtitle">Choose a wallet type</p>
